 ...
 * Own Profile InterestsScreen uses this onboarding catalog (not InterestLabel logos).
 * Legacy InterestLabel / InterestsWithLogo remains for affiliation logos only.
 */
...
export const ONBOARDING_INTEREST_CATEGORIES: OnboardingInterestCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      item('technology_digital_innovation', 'Digital innovation', 'sparkles-outline', '#DB2777'),
      item('technology_robotics', 'Robotics', 'hardware-chip-outline', '#EA580C'),
      ...
      item('technology_emerging', 'Emerging technology', 'bulb-outline', '#2563EB'),
  ...
  },
  {
    ...
    groups: [
      group('music_group_genres', 'Music Genres', 'musical-notes-outline', '#7C3AED', [
        ...
        item('music_genre_reggaeton', 'Reggaeton', 'radio-outline', '#C026D3'),
  ...
  },
  {
    ...
    nameKey: 'fitness',
    items: [
      item('fitness_neighborhood_activities', 'Neighborhood activities', 'home-outline', '#0891B2'),
...
import { assertKnownHierarchicalCategories } from './interestHierarchy.ts';
