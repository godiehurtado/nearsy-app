...
export const ONBOARDING_INTEREST_CATEGORIES: OnboardingInterestCategory[] = [
  {
    ...
    items: [
      ...
      item('business_small_business', 'Small businesses', 'storefront-outline', '#EA580C'),
      ...
      item('business_investing', 'Investments', 'trending-up-outline', '#059669'),
      item('business_networking', 'Networking', 'git-network-outline', '#4F46E5'),
      item('business_franchising', 'Franchises', 'business-outline', '#DC2626'),
  ...
  },
  {
    ...
    items: [
      ...
      item('technology_software', 'Software development', 'code-slash-outline', '#4F46E5'),
      item('technology_cybersecurity', 'Cybersecurity', 'shield-checkmark-outline', '#DC2626'),
      item('technology_digital_innovation', 'Digital innovation', 'analytics-outline', '#DB2777'),
      item('technology_robotics', 'Robotics', 'hardware-chip-outline', '#0D9488'),
      item('technology_gaming', 'Gaming', 'game-controller-outline', '#C026D3'),
      item('technology_crypto', 'Crypto', 'cash-outline', '#CA8A04'),
  ...
  },
  {
    ...
    groups: [
      group('music_group_genres', 'Music Genres', 'musical-notes-outline', '#7C3AED', [
        item('music_genre_rock_alternative', 'Rock and alternative', 'flash-outline', '#DC2626'),
        item('music_genre_pop', 'Pop', 'sparkles-outline', '#DB2777'),
        item('music_genre_electronic', 'Electronic music', 'radio-outline', '#4F46E5'),
        item('music_genre_country_folk', 'Country and folk', 'leaf-outline', '#16A34A'),
        item('music_genre_jazz_blues', 'Jazz and blues', 'wine-outline', '#0891B2'),
        item('music_genre_classical', 'Instrumental music', 'musical-notes-outline', '#7C3AED'),
        item('music_genre_faith', 'Faith music', 'heart-outline', '#CA8A04'),
        item('music_genre_reggaeton', 'Reggaeton', 'headset-outline', '#C026D3'),
      ...
      group('music_group_dance', 'Dance', 'footsteps-outline', '#DB2777', [
        item('music_dance_salsa', 'Salsa', 'flame-outline', '#EA580C'),
        item('music_dance_bachata', 'Bachata', 'heart-outline', '#DB2777'),
        item('music_dance_hip_hop', 'Hip hop', 'headset-outline', '#C026D3'),
        item('music_dance_contemporary', 'Contemporary dance', 'flash-outline', '#4F46E5'),
        item('music_dance_ballroom', 'Ballroom', 'diamond-outline', '#7C3AED'),
      ...
      group('music_group_live', 'Live Entertainment', 'mic-outline', '#EA580C', [
        item('music_live_events', 'Musical events', 'calendar-outline', '#2563EB'),
  ...
  },
  {
    ...
    groups: [
      group('food_group_dietary', 'Dietary Lifestyle', 'nutrition-outline', '#16A34A', [
        ...
        item('food_dietary_organic', 'Organic', 'leaf-outline', '#16A34A'),
      ...
      group('food_group_cuisines', 'Favorite Cuisines', 'restaurant-outline', '#EA580C', [
        ...
        item('food_cuisine_latin_american', 'Latin American', 'globe-outline', '#0891B2'),
  ...
  },
  {
    ...
    nameKey: 'fitness',
    items: [
      item('fitness_neighborhood_activities', 'Neighborhood activities', 'home-outline', '#0D9488'),
      item('fitness_gym', 'Gym and strength training', 'barbell-outline', '#DC2626'),
      ...
      item('fitness_mental', 'Mental well-being', 'happy-outline', '#4F46E5'),
      ...
      item('fitness_spa', 'Spa and self-care', 'sparkles-outline', '#DB2777'),
 ...
 * Selectable 2.0.4 catalog only — deprecated IDs live in interestLegacyCatalog.
 */
...
let selectableCatalogIdSet: Set<string> | null = null;

/** Selectable catalog IDs only (excludes Other and legacy/deprecated). */
export function getSelectableCatalogInterestIdSet(): Set<string> {
  if (!selectableCatalogIdSet) {
    selectableCatalogIdSet = new Set(
      flattenCatalogInterestItems().map((item) => item.id),
    );
  }
  return selectableCatalogIdSet;
}

export function isSelectableCatalogInterestId(id: string): boolean {
  return getSelectableCatalogInterestIdSet().has(id);
}

export function findSelectableCatalogInterestItem(
  id: string,
): OnboardingInterestItem | undefined {
  return flattenCatalogInterestItems().find((item) => item.id === id);
}
