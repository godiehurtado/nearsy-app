import type { AffiliationCategory, AffiliationItem } from '../types/profile.ts';
import {
...
import { buildAffiliationFieldPersistencePatch } from './onboardingAffiliationPersistence.ts';
