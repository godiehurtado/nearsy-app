...
import { createFakePhoneOtpClient } from '../callables/fakeClient.ts';
import { createPhoneOtpController } from '../phoneOtpController.ts';
import { buildPostAuthResetRoutes } from '../postAuthNavigation.ts';
import { performPhoneOtpOnboardingLogout } from '../onboardingLogout.ts';
import {
  createPhoneOtpSignOutPressHandler,
  resetAuthNavigationToLogin,
  runPhoneOtpScreenSignOut,
} from '../phoneOtpSignOut.ts';
import {
  ageFromBirthDate,
  birthPartsFromIso,
