  ...
  onboarding: {
    ...
    profileCompletion: {
      ...
      interestsCelebration: {
        ...
        nextTitle: 'Comunidades y afiliaciones',
        nextBody:
          'Tus intereses son un gran comienzo. A continuación, cuéntanos sobre las comunidades y organizaciones que forman parte de tu mundo — solo si quieres compartirlo.',
        continue: 'Continuar',
      },
      interests: {
        next: 'Siguiente',
